...
description: Important skills of a software architect. Sometimes architects are seen as both (a) the “glue” between different stakeholders and (b) the person focused on the technical delivery of the software product.
...
- [Become a Better Software Architect](#become-a-better-software-architect)
  - [Contents](#contents)
