...
description: Top-10 Rules for Git Practices, Using Git properly is essential for successful web-application development and CI/CD. The best practices for GitFlow have been codified and condensed into **10 Essential Rules**
tags: git, best practices, 10 Rules
author: Thomas Burleson
createdOn: December 20, 2019
lang: en
---

<Image src={`/static/images/git-top-10-rules/JcJo9n8.png`} alt={``} width={1064} height={364} />
...
<Image src={`/static/images/git-top-10-rules/D5Ypxex.png`} alt={``} width={1044} height={123} />
...
7.  [Improve your **Log History**](#7-Improved-Git-Logs)
8.  [Don't commit **Dependencies**](#8-dont-commit-dependencies)
9.  [Use **Prettier**](#9-Use-Prettier)
10. [Use **README**(s)](#10-Use-README)
...
<Image src={`/static/images/git-top-10-rules/Hz1lZLd.png`} alt={``} width={2182} height={1216} />
...
<Image src={`/static/images/git-top-10-rules/4PKB2Sf.png`} alt={``} width={1802} height={750} />
...
<Image src={`/static/images/git-top-10-rules/dM8g82D.png`} alt={``} width={1108} height={836} />
...
<Image src={`/static/images/git-top-10-rules/IXJ6FlX.png`} alt={``} width={1882} height={1446} />
...
<Image src={`/static/images/git-top-10-rules/H5ghBdu.png`} alt={``} width={1442} height={1120} />
...
<Image src={`/static/images/git-top-10-rules/6Aw1iGy.png`} alt={``} width={1702} height={1934} />
...
<Image src={`/static/images/git-top-10-rules/pRvFJfw.png`} alt={``} width={1418} height={582} />
...
:::info
:bulb: Full details: **[Commit Conventions](#_git-appendix-commit-conventions.mdx)**
:::
...
<Image src={`/static/images/git-top-10-rules/PKk7tWp.png`} alt={``} width={1178} height={530} />
...
<Image src={`/static/images/git-top-10-rules/NX01Ffe.png`} alt={``} width={1400} height={1028} />
...
<Image src={`/static/images/git-top-10-rules/soicP2u.png`} alt={``} width={1105} height={353} />
...
:::info
:bulb: Full details: [**Customizing your Git Log**](#_git-appendix-customized-logs.mdx)
:::
...
:::info
:bulb: Full Details here: \[**Recommended .gitIgnore Settings**]#\_git-appendix-gitignore-settings.mdx)
:::
...
<Image src={`/static/images/git-top-10-rules/5klO4el.png`} alt={``} width={1754} height={1664} />

Badges should be used in the root project README to highlight version, CI status, and more

<Image src={`/static/images/git-top-10-rules/TYFSOS1.png`} alt={``} width={2158} height={594} />
...
- [Customized Git Logs](./_git-appendix-customized-logs.mdx)
- [Commit Message Conventions](./_git-appendix-commit-conventions.mdx)
- [`.gitignore` settings](./_git-appendix-gitignore-settings.mdx)
