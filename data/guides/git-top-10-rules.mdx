...
---
    ...
    <Image
      src={`/static/images/git-top-10-rules/JcJo9n8.png`}
      alt={``}
      width={1064}
      height={364}
    />
...
<br>
    ...
    <Image
      src={`/static/images/git-top-10-rules/D5Ypxex.png`}
      alt={``}
      width={1044}
      height={123}
    />
...
- - [(1) Use GitFlow Strategy](#1-use-gitflow-strategy)
  ...
  - [(4) Use Fast-Forward Merge](#4-use-fast-forward-merge)
    ...
    - - [After the PR Merge...](#after-the-pr-merge)

  - [(5) Use Commit Conventions](#5-use-commit-conventions)

    - - [Why are conformance to Commit Conventions critical?](#why-are-conformance-to-commit-conventions-critical)
      - [Commit Convention Details](#commit-convention-details)

  - [(6) Require a Code Review process](#6-require-a-code-review-process)

  - [(7) Improved Git Logs](#7-improved-git-logs)
  ...
  - [(10) Use README(s)](#10-use-readmes)
...
Unlike [Trunk-based Git](https://www.toptal.com/software/trunk-based-development-git-flow) development, the **Gitflow** workflow defines strict branching models designed around pull-requests and multi-team project releases.
    ...
    <Image
      src={`/static/images/git-top-10-rules/Hz1lZLd.png`}
      alt={``}
      width={2182}
      height={1216}
    />
...
:::
    ...
    <Image
      src={`/static/images/git-top-10-rules/4PKB2Sf.png`}
      alt={``}
      width={1802}
      height={750}
    />
...
To enforce the **Merge by Pull-Request** process, the branches `master`, `develop`, and `release` should be locked to prevent direct push commits.
    ...
    <Image
      src={`/static/images/git-top-10-rules/dM8g82D.png`}
      alt={``}
      width={1108}
      height={836}
    />
...
Developers should **always** use `git pull --rebase origin <branch>` to insert all _origin_ changes below the timeline of their current changes.
    ...
    <Image
      src={`/static/images/git-top-10-rules/IXJ6FlX.png`}
      alt={``}
      width={1882}
      height={1446}
    />
...
Your Pull Request has been rebased, commits squashed, pushed to `origin`, and all CI tests and checks are passing. After code reviews, reviewer approvals and LGTMs... it is time to merge your PR to `origin/develop`.
    ...
    <Image
      src={`/static/images/git-top-10-rules/H5ghBdu.png`}
      alt={``}
      width={1442}
      height={1120}
    />
...
e.g.
    ...
    <Image
      src={`/static/images/git-top-10-rules/6Aw1iGy.png`}
      alt={``}
      width={1702}
      height={1934}
    />
...
e.g.
    ...
    <Image
      src={`/static/images/git-top-10-rules/pRvFJfw.png`}
      alt={``}
      width={1418}
      height={582}
    />
...
Code changes are merged into `origin/develop` only with Pull Requests
    ...
    <Image
      src={`/static/images/git-top-10-rules/PKk7tWp.png`}
      alt={``}
      width={1178}
      height={530}
    />
...
Here is project history for teams **NOT** following best practices:
    ...
    <Image
      src={`/static/images/git-top-10-rules/NX01Ffe.png`}
      alt={``}
      width={1400}
      height={1028}
    />
...
Here the team is following bes practices: Rebasing, Squash, and Commit Conventions. These all work togehter to ensure the git history will be flat, clean, and concise.
    ...
    <Image
      src={`/static/images/git-top-10-rules/soicP2u.png`}
      alt={``}
      width={1105}
      height={353}
    />
...
README documents should be hyperlinked to support easy navigation.
    ...
    <Image
      src={`/static/images/git-top-10-rules/5klO4el.png`}
      alt={``}
      width={1754}
      height={1664}
    />
...
Badges should be used in the root project README to highlight version, CI status, and more
    ...
    <Image
      src={`/static/images/git-top-10-rules/TYFSOS1.png`}
      alt={``}
      width={2158}
      height={594}
    />
