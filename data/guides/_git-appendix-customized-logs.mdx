...
<Image src={`/static/images/_git-appendix-customized-logs/foFNikr.png`} alt={``} width={2074} height={950} />
...
<Image src={`/static/images/_git-appendix-customized-logs/Z7uHhrg.png`} alt={``} width={1990} height={644} />
...
<Image src={`/static/images/_git-appendix-customized-logs/X7GqE8H.png`} alt={``} width={1004} height={48} />

##### After

<Image src={`/static/images/_git-appendix-customized-logs/B0xydnC.png`} alt={``} width={1008} height={48} />

<Image src={`/static/images/_git-appendix-customized-logs/0bjijXi.png`} alt={``} width={1006} height={44} />
